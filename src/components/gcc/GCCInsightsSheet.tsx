...
export default function GCCInsightsSheet({ count, suggestions, claimFocused, onClaimFocus }: Props) {
  ...
  return (
    <section aria-labelledby="insights-title" className="relative w-full">
      ...
      <div className="gcc-insights-shell relative overflow-hidden rounded-[20px] border border-emerald-200/80 bg-[#fbfdfc]/95 shadow-[0_12px_34px_rgba(46,125,112,0.1)] backdrop-blur-xl">
        ...
        <div className="relative flex h-6 items-center justify-center bg-white/45">
          <span className="h-1 w-9 rounded-full bg-slate-300/90" />
        </div>
        <div className="gcc-insights-scroll relative h-[430px] overflow-y-auto overscroll-contain px-2.5 pb-3 sm:px-3.5">
